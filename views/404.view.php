...
<main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
  <div class="text-center">
    <h1 class="text-3xl text-base font-semibold text-indigo-600">404<h1/>
    <h2 class="mt-4 text-xl font-bold tracking-tight text-gray-900 sm:text-5xl">Page not found</h2>
